...
{
    "id": "1",
    "timestamp": datetime.datetime.now() - datetime.timedelta(27000),
    "team": "Invictus",
    "action": "available",
    "country": COUNTRIES.BRAZIL,
},
{
    "id": "2",
    "timestamp": datetime.datetime.now() - datetime.timedelta(45000),
    "team": "CyberSamurai",
...
{
    "id": "3",
    "timestamp": datetime.datetime.now() - datetime.timedelta(60000),
    "team": "Mh0c473",
    "action": "captured",
    "country": COUNTRIES.INDIA,
},
{
    "id": "4",
    "timestamp": datetime.datetime.now() - datetime.timedelta(90000),
    "team": "RedDragon",
    "action": "captured",
    "country": COUNTRIES.CHINA,
},
{
    "id": "5",
    "timestamp": datetime.datetime.now() - datetime.timedelta(120000),
    "team": "Punina",
    "action": "captured",
    "country": COUNTRIES.BRAZIL,
},
{
    "id": "6",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1150000),
    "team": "ByteForBait",
    "action": "available",
    "country": COUNTRIES.GERMANY,
},
{
    "id": "7",
    "timestamp": datetime.datetime.now() - datetime.timedelta(11180000),
    "team": "AyamKunyit",
    "action": "captured",
    "country": COUNTRIES.ANGOLA,
},
{
    "id": "8",
    "timestamp": datetime.datetime.now() - datetime.timedelta(111210000),
    "team": "DigitalKnights",
    "action": "failed attempt",
    "country": COUNTRIES.UNITED_KINGDOM,
},
{
    "id": "9",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1112240000),
    "team": "PhoenixTeam",
    "action": "captured",
    "country": COUNTRIES.SOUTH_AFRICA,
},
{
    "id": "10",
    "timestamp": datetime.datetime.now() - datetime.timedelta(11122300000),
    "team": "NordicHackers",
    "action": "available",
    "country": COUNTRIES.FRANCE,
},
...
{
    "id": "11",
    "timestamp": datetime.datetime.now() - datetime.timedelta(360000),
    "team": "TechNinjas",
    "action": "captured",
    "country": COUNTRIES.SOUTH_KOREA,
},
{
    "id": "12",
    "timestamp": datetime.datetime.now() - datetime.timedelta(420000),
    "team": "CyberBears",
    "action": "failed attempt",
    "country": COUNTRIES.RUSSIA,
},
{
    "id": "13",
    "timestamp": datetime.datetime.now() - datetime.timedelta(480000),
    "team": "EagleEye",
    "action": "captured",
    "country": COUNTRIES.USA,
},
{
    "id": "14",
    "timestamp": datetime.datetime.now() - datetime.timedelta(540000),
    "team": "MapleHackers",
    "action": "available",
    "country": COUNTRIES.CANADA,
},
{
    "id": "15",
    "timestamp": datetime.datetime.now() - datetime.timedelta(600000),
    "team": "PastaSquad",
    "action": "failed attempt",
    "country": COUNTRIES.ITALY,
},
{
    "id": "16",
    "timestamp": datetime.datetime.now() - datetime.timedelta(660000),
    "team": "TequilaTeam",
    "action": "captured",
    "country": COUNTRIES.MEXICO,
},
{
    "id": "17",
    "timestamp": datetime.datetime.now() - datetime.timedelta(720000),
    "team": "FlamencoForce",
    "action": "available",
    "country": COUNTRIES.SPAIN,
},
{
    "id": "18",
    "timestamp": datetime.datetime.now() - datetime.timedelta(780000),
    "team": "KangarooKrew",
    "action": "captured",
    "country": COUNTRIES.AUSTRALIA,
},
{
    "id": "19",
    "timestamp": datetime.datetime.now() - datetime.timedelta(840000),
    "team": "GarudaGuards",
    "action": "failed attempt",
    "country": COUNTRIES.INDONESIA,
},
{
    "id": "20",
    "timestamp": datetime.datetime.now() - datetime.timedelta(900000),
    "team": "TulipTactics",
    "action": "captured",
    "country": COUNTRIES.NETHERLANDS,
},
{
    "id": "21",
    "timestamp": datetime.datetime.now() - datetime.timedelta(960000),
    "team": "DesertStorm",
    "action": "available",
    "country": COUNTRIES.SAUDI_ARABIA,
},
{
    "id": "22",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1020000),
...
{
    "id": "23",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1080000),
...
{
    "id": "24",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1140000),
    "team": "TangoMasters",
    "action": "available",
    "country": COUNTRIES.ARGENTINA,
},
{
    "id": "25",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1200000),
    "team": "NollywoodNet",
    "action": "captured",
    "country": COUNTRIES.NIGERIA,
},
{
    "id": "26",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1260000),
...
{
    "id": "27",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1320000),
    "team": "CyberSamurai",
    "action": "captured",
    "country": COUNTRIES.JAPAN,
},
{
    "id": "28",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1380000),
    "team": "RedDragon",
    "action": "available",
    "country": COUNTRIES.CHINA,
},
{
    "id": "29",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1440000),
    "team": "DiamondDiggers",
    "action": "captured",
    "country": COUNTRIES.SOUTH_AFRICA,
},
{
    "id": "30",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1500000),
    "team": "BollywoodBytes",
    "action": "failed attempt",
    "country": COUNTRIES.INDIA,
},
{
    "id": "31",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1560000),
...
{
    "id": "32",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1620000),
    "team": "EnigmaExperts",
    "action": "available",
    "country": COUNTRIES.GERMANY,
},
{
    "id": "33",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1680000),
    "team": "TeaTimeHackers",
    "action": "failed attempt",
    "country": COUNTRIES.UNITED_KINGDOM,
},
{
    "id": "34",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1740000),
    "team": "OilRigRaiders",
    "action": "captured",
    "country": COUNTRIES.ANGOLA,
},
{
    "id": "35",
    "timestamp": datetime.datetime.now() - datetime.timedelta(1800000),
    "team": "StarSpangled",
    "action": "available",
    "country": COUNTRIES.USA,
},
